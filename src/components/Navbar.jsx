...
export default function Navbar() {
  ...
  return (
    <div className="navbar">
      <Link to="/"><img className="navbar_homeIcon" src={homeIcon} alt="Home icon" onClick={() => { setProductResult(null); setBarCode(null) }} /></Link>
      <Link to="/favorites"><img className="navbar__emptyStarIcon" src={blackEmptyStar} alt="Black empty star" /></Link>
      <Link to="/searchresult" ><img className="navbar__glassIcon" src={glass} alt="Glass" /></Link>
      <Link to="/" ><img className="navbar__barcodeIcon" src={barCodePict} alt="Bar code" /></Link>
    </div>
  )
}